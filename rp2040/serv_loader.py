...
# These match the RP2040-to-FPGA bridge on the board
SPI_SCK_PIN = 3   # GP3 - SPI Clock
SPI_MOSI_PIN = 5  # GP5 - Master Out Slave In
SPI_MISO_PIN = 6  # GP6 - Master In Slave Out (not used but required)
